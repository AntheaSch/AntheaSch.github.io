...
var drawCircles2 = function(nr_points, nr_white) {
  var RADIUS = 8; //radius of circles
  var WIDTH = 400; //canvas
  var HEIGHT = 200; //canvas (canvas is area where image is constructed)
...
//draw circles with fitting coordinates
  ...
  draw('circles2', nr_points, nr_white); //id of canvas
};

...
var items = [
    ...
    {"context": "A friend’s favorite book has been published only recently. Compared to what you would expect for a book, the book has __ pages.",
    ...
    {"context": "Nick is a man from the US. Compared to what you would expect for a man from the US, Nick saw __ movies last year.",
    ...
    {"context": "A friend wants to read you her favorite poem. Compared to what you would expect for a poem, the poem has __ lines.",
...
/*    {"context": "Joseph is a man from the US who ate __ burgers last month.",
    ...
    {"context": "Melanie is a woman from the US. Compared to what you would expect for a woman from the US, Melanie owns __ pairs of shoes.",
    ...
    {"context": "Vehicle No. 102 is a school bus. Compared to what you would expect for a school bus, No. 102 has seats for __ passengers.",
   ...
   //  "bins_few": ["0-4", "10-14","20-24","30-34"],
    ...
    {"context": "Erin is a first grade student in primary school. Compared to what you would expect for a primary school class, there are __ children in Erin’s class.",
    ...
    {"context": "Betty is a woman from the US. Compared to what you would expect for a woman from the US, Betty washed her hair __ times last month.",
    ...
    {"context": "Lelia is a woman from the US. Compared to what you would expect for a woman from the US, Lelia has __ friends.",
    ...
    {"context": "Tony is a man from the US. Compared to what you would expect for a man from the US, Tony cooked himself __ meals at home last month.",
    ...
    {"context": "Liam is a man from the US. Compared to what you would expect for a man from the US, Liam has __ T-shirts.",
    ...
    {"context": "Judith is a woman from the US. Compared to what you would expect for a woman from the US, Judith has __ Facebook friends.",
...
//     "bins": ["0-69", "70-139","140-209","210-279","280-349","350-419","420-489","490-559","560-629","630-699","700-769","770-839","840-909","910-979","980 or more"],
    ...
    {"context": "Andy is man from the US. Compared to what you would expect for a man from the US, Andy drank __ cups of coffee last week.",
    ...
    {"context": "Lisa is a woman from the US. Compared to what you would expect for a woman from the US, Lisa made __ phone calls last week.",
    ...
    {"context": "Sarah is a woman from the US. Compared to what you would expect for a woman from the US, Sarah went to __ restaurants last year.",
...
/*    urn_image: function(stim) {           //id of div element, if same item is to be shown on different slides (with different tasks, for example
    ...
    log_responses: function() {
      ...
      //change this!!
            _s.this_trial_data["modifier"] = "compared";

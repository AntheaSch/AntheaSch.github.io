...
Distribution of balls: 100 balls, p(blue) = 0.5, draw 20 (10 items+10 fillers)
...
var items = [
    {
    quantifier: "many",
		item: "Many of the balls are blue.",
        filler: "no",
    ...
    {
		quantifier: "lots",
		item: "Lots of the balls are blue.",
        filler: "no",
        range: [[1,3],[4,5],[6,8],[9,10]],
	},
	{
		quantifier: "afew",
		item: "A few of the balls are blue.",
        filler: "no",
        range: [[1,1],[2,3],[4,5],[6,10]],
	},
	{
		quantifier: "several",
		item: "Several of the balls are blue.",
        filler: "no",
    ...
    {
		item: "Some of the balls are white.",
        quantifier: "filler",
        correct_answer: "no",
        filler: "yes",
        range: [[0,10]],
    ...
    {
		item: "The balls have three different colors.",
        quantifier: "filler",
        correct_answer: "no",
        filler: "yes",
        range: [[0,10]],
    ...
    {
		item: "All of the balls are green.",
        quantifier: "filler",
        correct_answer: "no",
        filler: "yes",
        range: [[0,10]],
    ...
    {
		item: "The balls are similar in size.",
        quantifier: "filler",
        correct_answer: "vague",
        filler: "yes",
        range: [[0,10]],
    ...
    {
		item: "The balls are far away from each other.",
        quantifier: "filler",
        correct_answer: "vague",
        filler: "yes",
        range: [[0,10]],
...
var urn_black = 50; //number of black balls in urn
var prob = urn_black/urn_total
console.log(prob);

//choose picture randomly
/*
images = ["images/50blue_50red_1.png", "images/50blue_50red_2.png", "images/50blue_50red_3.png", "images/50blue_50red_4.png", "images/50blue_50red_5.png"];
chosen_image = _.shuffle(images)[0];
console.log("image "+chosen_image);

var img = new Image();
var div = document.getElementById('insert_image');
...
var images = ["images/50blue_50red_1.png", "images/50blue_50red_2.png", "images/50blue_50red_3.png", "images/50blue_50red_4.png", "images/50blue_50red_5.png"];

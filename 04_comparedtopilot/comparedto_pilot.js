   ...
   {"prior_low": 'Harry and Joe are men from the US. Yesterday, Harry ate __ burgers and Chris ate __ burgers.',
    ...
    {"prior_low": 'Melanie and Barbara are women from the US. Yesterday, Melanie bought __ pairs of shoes and Barbara bought __ pairs of shoes.',
     ...
     "comparedto":'Compared to "The Forest", "Describing the World"  has many pages.',
      "plausLow": 'Is it plausible that "The Forest" has __ pages?',
     "plausHigh": 'Is it plausible that "Describing the World" has __ pages?',
     "predicate": 'many',
     "topic": 'books'}, 
    ...
    "plausLow": 'Is it plausible that Kevin is __ tall?',
     "plausHigh": 'Is it plausible that Paul is __ tall?',
     "predicate": 'tall',
     "topic": 'height'}, 
